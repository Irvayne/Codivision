...
import br.ufpi.ppgcc.mi.common.security.UserSession;
import br.ufpi.ppgcc.mi.core.dao.ConfigurationDAO;
...
import br.ufpi.ppgcc.mi.core.dao.UserRepositoryDAO;
...
import br.ufpi.ppgcc.mi.core.model.UserRepository;
...
import br.ufpi.ppgcc.mi.core.model.enums.TimeWindow;
import br.ufpi.ppgcc.mi.core.model.validator.ConfigurationValidator;
import br.ufpi.ppgcc.mi.core.model.validator.ExtractionPathValidator;
import br.ufpi.ppgcc.mi.core.model.validator.RepositoryValidator;
...
import br.ufpi.ppgcc.mi.core.util.BinaryFile;
...
public class RepositoryController {
	...
	public Download download(Long repositoryId) throws IOException {
		...
		newRepo.setExtractionPaths(new ArrayList<>());
...
//		}
	...
	public void authors(Long repositoryId) {
		
		result.use(Results.json()).withoutRoot().from(dao.getAuthores(repositoryId)).recursive().serialize();
	}
	
	@Permission(PermissionType.MEMBER)
	@Post("/repository/{repositoryId}/historyAuthor")
	public void historyAuthor(Long repositoryId, String author) {
